...
<div id="menu">    
    ...
    <c:if test="${empty user}">                
        ...
        <a href="javascript:openWindow('${identityLocation}/rest/1/identity/authorize?response_type=code&providerId=yota&client_id=${apiKey}&redirect_uri=${redirect_uri}')">Login</a>
